...
export type KnowledgeScienceCieScoreBatchV2Question =
  KnowledgeQuestionSeed & { provenance: ScoreModeProvenance };

type BatchQuestion = KnowledgeScienceCieScoreBatchV2Question;
...
const BATCH_ID = "knowledge_science_cie_score_v2";
const WORK_UNIT_ID = "score-mode:knowledge:science:static:v2";
...
const SI_UNIT_ROWS = [
  ["radian", "radian", "Q33680", "rad", "special-name", "en"],
  ["steradian", "steradian", "Q177612", "sr", "special-name", "en"],
  ["coulomb", "coulomb", "Q25406", "C", "special-name", "en"],
  ["degreeCelsius", "degree Celsius", "Q25267", "°C", "special-name", "en"],
  ["siemens", "siemens", "Q169893", "S", "special-name", "en"],
  ["weber", "weber", "Q170804", "Wb", "special-name", "en"],
  ["henry", "henry", "Q163354", "H", "special-name", "en"],
  ["lumen", "lumen", "Q484092", "lm", "special-name", "en"],
  ["lux", "lux", "Q179836", "lx", "special-name", "en"],
...
const ELEMENT_SYMBOL_SPECS: ElementSymbolSpec[] = [
  { atomicNumber: 23, difficulty: "intermediate", direction: "element_to_symbol" },
  { atomicNumber: 31, difficulty: "intermediate", direction: "symbol_to_element" },
  { atomicNumber: 33, difficulty: "intermediate", direction: "element_to_symbol" },
  { atomicNumber: 37, difficulty: "hard", direction: "symbol_to_element" },
  { atomicNumber: 38, difficulty: "intermediate", direction: "element_to_symbol" },
  { atomicNumber: 39, difficulty: "hard", direction: "symbol_to_element" },
  { atomicNumber: 41, difficulty: "hard", direction: "element_to_symbol" },
  { atomicNumber: 42, difficulty: "hard", direction: "symbol_to_element" },
  { atomicNumber: 43, difficulty: "hard", direction: "element_to_symbol" },
  { atomicNumber: 44, difficulty: "hard", direction: "symbol_to_element" },
  { atomicNumber: 45, difficulty: "hard", direction: "element_to_symbol" },
  { atomicNumber: 49, difficulty: "hard", direction: "symbol_to_element" },
  { atomicNumber: 55, difficulty: "hard", direction: "element_to_symbol" },
  { atomicNumber: 56, difficulty: "intermediate", direction: "symbol_to_element" },
  { atomicNumber: 57, difficulty: "hard", direction: "element_to_symbol" },
  { atomicNumber: 58, difficulty: "hard", direction: "symbol_to_element" },
  { atomicNumber: 59, difficulty: "hard", direction: "element_to_symbol" },
  { atomicNumber: 60, difficulty: "hard", direction: "symbol_to_element" },
  { atomicNumber: 61, difficulty: "hard", direction: "element_to_symbol" },
  { atomicNumber: 62, difficulty: "hard", direction: "symbol_to_element" },
];

const ELEMENT_ATOMIC_NUMBER_SPECS: ElementAtomicNumberSpec[] = [
  { atomicNumber: 1, difficulty: "easy", direction: "element_to_number" },
  { atomicNumber: 3, difficulty: "easy", direction: "number_to_element" },
  { atomicNumber: 4, difficulty: "easy", direction: "element_to_number" },
  { atomicNumber: 5, difficulty: "easy", direction: "number_to_element" },
  { atomicNumber: 6, difficulty: "easy", direction: "element_to_number" },
  { atomicNumber: 8, difficulty: "easy", direction: "number_to_element" },
  { atomicNumber: 9, difficulty: "easy", direction: "element_to_number" },
  { atomicNumber: 12, difficulty: "easy", direction: "number_to_element" },
  { atomicNumber: 14, difficulty: "intermediate", direction: "element_to_number" },
  { atomicNumber: 15, difficulty: "intermediate", direction: "number_to_element" },
  { atomicNumber: 16, difficulty: "intermediate", direction: "element_to_number" },
  { atomicNumber: 17, difficulty: "intermediate", direction: "number_to_element" },
  { atomicNumber: 19, difficulty: "intermediate", direction: "element_to_number" },
  { atomicNumber: 21, difficulty: "hard", direction: "number_to_element" },
  { atomicNumber: 23, difficulty: "hard", direction: "element_to_number" },
  { atomicNumber: 24, difficulty: "hard", direction: "number_to_element" },
  { atomicNumber: 25, difficulty: "hard", direction: "element_to_number" },
  { atomicNumber: 27, difficulty: "hard", direction: "number_to_element" },
  { atomicNumber: 29, difficulty: "intermediate", direction: "element_to_number" },
  { atomicNumber: 30, difficulty: "intermediate", direction: "number_to_element" },
];

const SI_UNIT_SYMBOL_SPECS: SiUnitSymbolSpec[] = [
  { key: "radian", difficulty: "intermediate", distractorKeys: ["steradian", "coulomb", "weber"] },
  { key: "steradian", difficulty: "hard", distractorKeys: ["radian", "henry", "lumen"] },
  { key: "coulomb", difficulty: "intermediate", distractorKeys: ["weber", "siemens", "becquerel"] },
  { key: "degreeCelsius", difficulty: "hard", distractorKeys: ["weber", "becquerel", "radian"] },
  { key: "siemens", difficulty: "hard", distractorKeys: ["coulomb", "weber", "becquerel"] },
  { key: "weber", difficulty: "hard", distractorKeys: ["henry", "coulomb", "radian"] },
  { key: "henry", difficulty: "hard", distractorKeys: ["weber", "steradian", "lumen"] },
  { key: "lumen", difficulty: "intermediate", distractorKeys: ["lux", "radian", "becquerel"] },
  { key: "lux", difficulty: "intermediate", distractorKeys: ["lumen", "steradian", "coulomb"] },
  { key: "becquerel", difficulty: "hard", distractorKeys: ["siemens", "weber", "henry"] },
];
...
export const knowledgeScienceCieScoreBatchV2Questions =
  RAW_FACTS.map(buildQuestion);
export const questions = knowledgeScienceCieScoreBatchV2Questions;
export const wikidataSourceRecords = buildWikidataSourceRecords(RAW_FACTS);

export const knowledgeScienceCieScoreBatchV2Metadata = {
  batchId: BATCH_ID,
  mode: "score",
  workUnitId: WORK_UNIT_ID,
  sourceType: "structured_open",
  ...
  verifierModel: VERIFIER_MODEL,
  verdict: VERDICT,
  questionCount: knowledgeScienceCieScoreBatchV2Questions.length,
  countsByCategory: countBy(
    knowledgeScienceCieScoreBatchV2Questions.map((question) => question.category),
  ),
  countsByDifficulty: countBy(
    knowledgeScienceCieScoreBatchV2Questions.map((question) => question.difficulty),
  ),
  ...
  canonicalScienceCategories: {
    ...
    si_unit_symbols:
      "Wikidata P5061; SI special-name units not used in science v1; authored only in the unit-to-symbol direction.",
  },
  wikidataSourcing: {
    chemical_element_symbols:
...
export default knowledgeScienceCieScoreBatchV2Questions;
