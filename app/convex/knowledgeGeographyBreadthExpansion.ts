...
const RAW_GEOGRAPHY_FACTS: RawGeographyFact[] = [
  ...
  q("currencies", "hard", "odd_one_out", "Which of these is NOT pegged or closely linked to the euro?", "Japanese yen", ["Danish krone", "Bosnia and Herzegovina convertible mark", "Bulgarian lev"], "The Danish krone, convertible mark, and Bulgarian lev are linked to the euro; the yen floats independently.", "currencies_structured"),
  ...
  q("physical_geography", "hard", "superlative_comparison", "Which listed strait is narrowest?", "Dover Strait", ["Bering Strait", "Malacca Strait", "Hormuz Strait"], "The Dover Strait is narrower than the other listed straits.", "physical_geography_structured"),
