    ...
    >
      ...
      >
        ...
        <Section eyebrow={t("weekend.howSquad", { defaultValue: "Your squad" })} testId="htp-squad">
          ...
          <PitchShapeFigure />
          <Rule label={t("weekend.howClubCapLabel", { defaultValue: "Club cap:" })}>{t("weekend.howClubCapBody", { defaultValue: "at most 3 players from one club — except your favorite club, which is unlimited. Set it once from the Favorite club card on the Weekend home. It is permanent: it can never be changed, so choose the club you actually support." })}</Rule>
